class Translate
  ...
  def self.register_error controller_name = nil
    I18n.t("general.error_message.register_error", model: I18n.t("activerecord.models.#{controller_name.underscore}"))
  end
  def self.edit_error controller_name = nil
    I18n.t("general.error_message.edit_error", model: I18n.t("activerecord.models.#{controller_name.underscore}"))
  end
  def self.destroy_error controller_name = nil
    I18n.t("general.error_message.destroy_error", model: I18n.t("activerecord.models.#{controller_name.underscore}"))
  end
end